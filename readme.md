 ...
 * Adherence to best coding practices
   * Add unit tests that cover the basic features of com.smallworld.TransactionDataFetcher. One test per method would be enough
 * Correctness
 * Efficiency
...
A battery of test transactions is stored in `transactions.json` that is going to be used as a datasource for all our com.smallworld.data mapping needs.
